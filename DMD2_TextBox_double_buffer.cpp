...
DMD_TextBox::DMD_TextBox(DMDFrameDoubleBuffer &dmd, int left, int top, bool scrollHorizontal,
                         int width, int height)
  : dmd(dmd), pending_newline(false), scrollHorizontal( scrollHorizontal), inverted(false), left(left), top(top),  width(width),
    height(height), cur_x(0), cur_y(0) {}
DMD_TextBox::DMD_TextBox(DMDFrameDoubleBuffer &dmd, bool scrollHorizontal )
  : dmd(dmd), pending_newline(false), scrollHorizontal( scrollHorizontal),  inverted(false), left(0), top(0),  width(dmd.width),
    height(dmd.height), cur_x(0), cur_y(0) {}
